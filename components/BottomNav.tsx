        ...
        >
          ...
          >
            <a
              ...
              className="text-xs sm:text-sm tracking-[0.08em] uppercase text-white transition-opacity duration-200 hover:opacity-50 min-h-[44px] flex items-center px-3 cursor-pointer"
